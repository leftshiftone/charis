...
export default class SvgPlus extends Component<SvgProps, {}> {
    ...
    public render() {
        ...
        return (
            <svg style={{width, height}} className={this.props.class} onClick={this.props.onClick} width="100mm" height="100mm"
